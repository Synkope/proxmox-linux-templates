...
CONFIGS = ubuntu-24.04-cloud.conf debian-12-cloud.conf debian-12-cloud-docker.conf ubuntu-24.04-cloud-docker.conf fedora-38-cloud.conf almalinux-9-cloud.conf
